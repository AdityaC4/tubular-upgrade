(module
  ...
  (data (i32.const 14) "ONE\00")
  (global $free_mem (mut i32) (i32.const 18))
  ...
  (func $One (result i32)
    ;; Variables
    (local $var1 i32)                                                          ;; Variable: one
    
    ;; Temp Variables
    
    (i32.const 14)                                                             ;; Load address of string literal
    (local.set $var1)                                                          ;; Set var 'one' from stack
    (local.get $var1)                                                          ;; Place var 'one' onto stack
  )                                                                          ;; END 'One' function definition.
