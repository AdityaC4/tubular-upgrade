(module
  ...
  (func $Inc2 (param $var2 i32) (result i32)
    ;; Variables
    (local $var4 i32)                                                          ;; Variable: part
    
    ;; Temp Variables
    
    (local.get $var2)                                                          ;; Place var 'val' onto stack
    (i32.const 1)                                                              ;; Put a 1 on the stack
    (i32.add)                                                                  ;; Stack2 + Stack1
    (local.set $var4)                                                          ;; Set var 'part' from stack
    (local.get $var4)                                                          ;; Place var 'part' onto stack
    (i32.const 1)                                                              ;; Put a 1 on the stack
    (i32.add)                                                                  ;; Stack2 + Stack1
  )                                                                          ;; END 'Inc2' function definition.
  
  (export "Inc2" (func $Inc2))
