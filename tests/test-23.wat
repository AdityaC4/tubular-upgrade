(module
  ...
  (data (i32.const 14) "match\00")
  (data (i32.const 20) "no match\00")
  (global $free_mem (mut i32) (i32.const 29))
  ...
  (func $StrCmp (param $var0 i32) (param $var1 i32) (result i32)
    ;; Variables
    ...
    call $_str_cmp                                                             ;; call string compare function
  ...
  )                                                                          ;; END 'StrCmp' function definition.
