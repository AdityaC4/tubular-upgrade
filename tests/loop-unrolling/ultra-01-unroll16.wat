(module
  ...
  (func $UltraLight (result i32)
    ;; Variables
    (local $var1 i32)                                                          ;; Variable: sum
    (local $var2 i32)                                                          ;; Variable: i
    
    ;; Temp Variables
    
    (i32.const 0)                                                              ;; Put a 0 on the stack
    (local.set $var1)                                                          ;; Set var 'sum' from stack
    (i32.const 0)                                                              ;; Put a 0 on the stack
    ...
    (block $exit1                                                              ;; Outer block for breaking while loop.
      (loop $loop1                                                             ;; Inner loop for continuing while.
        ...
        (i32.const 100000000)                                                      ;; Put a 100000000 on the stack
        ...
        ;; WHILE Loop body...
        (local.get $var1)                                                          ;; Place var 'sum' onto stack
        (local.get $var2)                                                          ;; Place var 'i' onto stack
    ...
    (local.get $var1)                                                          ;; Place var 'sum' onto stack
  )                                                                          ;; END 'UltraLight' function definition.
  
  (export "UltraLight" (func $UltraLight))
