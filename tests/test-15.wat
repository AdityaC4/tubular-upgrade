(module
  ...
  (func $ToUpperL (param $var0 i32) (result i32)
    ;; Variables
    ...
    ;; Setup the && operation
    (local.get $var0)                                                          ;; Place var 'l' onto stack
    (i32.const 97)                                                             ;; Put a char \97 on the stack
    (i32.ge_s)                                                                 ;; Stack2 >= Stack1
    (if (result i32)                                                           ;; Setup for && operator
      (then
        (local.get $var0)                                                          ;; Place var 'l' onto stack
        (i32.const 122)                                                            ;; Put a char \122 on the stack
    ...
    (if                                                                        ;; Execute code based on result of condition.
      (then                                                                      ;; 'then' block
        ...
        (i32.const 65)                                                             ;; Put a char \65 on the stack
        (i32.add)                                                                  ;; Stack2 + Stack1
        (return)                                                                   ;; Halt and return value.
      )                                                                          ;; End 'then'
    )                                                                          ;; End 'if'
    (local.get $var0)                                                          ;; Place var 'l' onto stack
  )                                                                          ;; END 'ToUpperL' function definition.
  
  (export "ToUpperL" (func $ToUpperL))
  
  (func $ToUpper (param $var2 i32) (result i32)
    ;; Variables
    (local $var4 i32)                                                          ;; Variable: index
    
    ;; Temp Variables
    
    (i32.const 0)                                                              ;; Put a 0 on the stack
    (local.set $var4)                                                          ;; Set var 'index' from stack
    (block $exit1                                                              ;; Outer block for breaking while loop.
      (loop $loop1                                                             ;; Inner loop for continuing while.
        ;; WHILE Test condition...
        (local.get $var4)                                                          ;; Place var 'index' onto stack
        (local.get $var2)                                                          ;; Place var 'str' onto stack
        ...
        (call $ToUpperL)                                                           ;; Call function ToUpperL
        (local.get $var2)                                                          ;; Place var 'str' onto stack
        (local.get $var4)                                                          ;; Place var 'index' onto stack
