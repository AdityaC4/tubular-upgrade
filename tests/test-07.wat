(module
  ...
  (data (i32.const 14) "Hello\00")
  (data (i32.const 20) "World!\00")
  (global $free_mem (mut i32) (i32.const 27))
  ...
  (func $HelloPlusPlus (result i32)
    ...
    (i32.const 32)                                                             ;; Put a char \32 on the stack
    i32.store8                                                                 ;; Store the char at the address
    (local.get $temp0)                                                         ;; Return address of the string
    call $_strcat                                                              ;; Concatenate two strings
    (i32.const 20)                                                             ;; Load address of string literal
    call $_strcat                                                              ;; Concatenate two strings
  )                                                                          ;; END 'HelloPlusPlus' function definition.
  
  (export "HelloPlusPlus" (func $HelloPlusPlus))
