(module
  ...
  (func $Mult (param $var0 f64) (param $var1 f64) (result f64)
    ;; Variables
  ...
  )                                                                          ;; END 'Mult' function definition.
  
  (export "Mult" (func $Mult))
  
  (func $Mult4 (param $var3 f64) (param $var4 f64) (param $var5 f64) (param $var6 f64) (result f64)
    ;; Variables
    
    ;; Temp Variables
    
    (local.get $var3)                                                          ;; Place var 'val1' onto stack
    (local.get $var4)                                                          ;; Place var 'val2' onto stack
    (call $Mult)                                                               ;; Call function Mult
    (local.get $var5)                                                          ;; Place var 'val3' onto stack
    (local.get $var6)                                                          ;; Place var 'val4' onto stack
    (call $Mult)                                                               ;; Call function Mult
    (call $Mult)                                                               ;; Call function Mult
  )                                                                          ;; END 'Mult4' function definition.
  
  (export "Mult4" (func $Mult4))
