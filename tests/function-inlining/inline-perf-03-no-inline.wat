(module
  ...
  )                                                                          ;; END 'get_const' function definition.
  ...
  (func $main (result i32)
    ...
    (i32.const 0)                                                              ;; Put a 0 on the stack
    (local.set $var3)                                                          ;; Set var 'i' from stack
    (block $exit1                                                              ;; Outer block for breaking while loop.
      (loop $loop1                                                             ;; Inner loop for continuing while.
        ;; WHILE Test condition...
        (local.get $var3)                                                          ;; Place var 'i' onto stack
        (i32.const 4000000)                                                        ;; Put a 4000000 on the stack
        ...
        (call $get_const)                                                          ;; Call function get_const
