(module
  ...
  (func $double_it (param $var0 i32) (result i32)
    ;; Variables
  ...
  )                                                                          ;; END 'double_it' function definition.
  
  (export "double_it" (func $double_it))
  
  (func $main (result i32)
    ;; Variables
    (local $var3 i32)                                                          ;; Variable: result
    ...
    (i32.const 2)                                                              ;; Put a 2 on the stack
    (i32.mul)                                                                  ;; Stack2 * Stack1
    (local.set $var3)                                                          ;; Set var 'result' from stack
    (local.get $var3)                                                          ;; Place var 'result' onto stack
