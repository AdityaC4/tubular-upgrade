(module
  ...
  (func $f1 (param $var0 i32) (result i32)
    ;; Variables
  ...
  )                                                                          ;; END 'f1' function definition.
  
  (export "f1" (func $f1))
  
  (func $f2 (param $var2 i32) (result i32)
    ;; Variables
    
    ;; Temp Variables
    
    (local.get $var2)                                                          ;; Place var 'x' onto stack
    (i32.const 2)                                                              ;; Put a 2 on the stack
    (i32.add)                                                                  ;; Stack2 + Stack1
  )                                                                          ;; END 'f2' function definition.
  
  (export "f2" (func $f2))
  
  (func $f3 (param $var4 i32) (result i32)
    ;; Variables
    
    ;; Temp Variables
    
    (local.get $var4)                                                          ;; Place var 'x' onto stack
    (i32.const 3)                                                              ;; Put a 3 on the stack
    (i32.add)                                                                  ;; Stack2 + Stack1
  )                                                                          ;; END 'f3' function definition.
  
  (export "f3" (func $f3))
  
  (func $f4 (param $var6 i32) (result i32)
    ;; Variables
    
    ;; Temp Variables
    
    (local.get $var6)                                                          ;; Place var 'x' onto stack
    (i32.const 4)                                                              ;; Put a 4 on the stack
    (i32.add)                                                                  ;; Stack2 + Stack1
  )                                                                          ;; END 'f4' function definition.
  
  (export "f4" (func $f4))
  
  (func $main (result i32)
    ;; Variables
    (local $var9 i32)                                                          ;; Variable: x
    (local $var10 i32)                                                         ;; Variable: i
    ...
    (i32.const 0)                                                              ;; Put a 0 on the stack
    (local.set $var10)                                                         ;; Set var 'i' from stack
    (block $exit1                                                              ;; Outer block for breaking while loop.
      (loop $loop1                                                             ;; Inner loop for continuing while.
        ...
        ;; WHILE Loop body...
        (local.get $var9)                                                          ;; Place var 'x' onto stack
