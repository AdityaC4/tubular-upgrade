(module
  ...
  )                                                                          ;; END 'get_five' function definition.
  
  (export "get_five" (func $get_five))
  
  (func $get_ten (result i32)
    ;; Variables
    
    ;; Temp Variables
    
    (i32.const 10)                                                             ;; Put a 10 on the stack
  )                                                                          ;; END 'get_ten' function definition.
  
  (export "get_ten" (func $get_ten))
  
  (func $main (result i32)
    ;; Variables
    (local $var3 i32)                                                          ;; Variable: a
    (local $var4 i32)                                                          ;; Variable: b
    
    ;; Temp Variables
    
    (i32.const 5)                                                              ;; Put a 5 on the stack
    (local.set $var3)                                                          ;; Set var 'a' from stack
    (i32.const 10)                                                             ;; Put a 10 on the stack
    (local.set $var4)                                                          ;; Set var 'b' from stack
    (local.get $var3)                                                          ;; Place var 'a' onto stack
    (local.get $var4)                                                          ;; Place var 'b' onto stack
