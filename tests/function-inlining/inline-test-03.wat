(module
  ...
  (func $complex_calc (param $var0 i32) (result i32)
    ;; Variables
    (local $var2 i32)                                                          ;; Variable: temp1
    (local $var3 i32)                                                          ;; Variable: temp2
    (local $var4 i32)                                                          ;; Variable: temp3
    (local $var5 i32)                                                          ;; Variable: temp4
    ...
    (local.set $var2)                                                          ;; Set var 'temp1' from stack
    (local.get $var2)                                                          ;; Place var 'temp1' onto stack
    (i32.const 2)                                                              ;; Put a 2 on the stack
    (i32.mul)                                                                  ;; Stack2 * Stack1
    (local.set $var3)                                                          ;; Set var 'temp2' from stack
    (local.get $var3)                                                          ;; Place var 'temp2' onto stack
    (i32.const 1)                                                              ;; Put a 1 on the stack
    (i32.sub)                                                                  ;; Stack2 - Stack1
    (local.set $var4)                                                          ;; Set var 'temp3' from stack
    (local.get $var4)                                                          ;; Place var 'temp3' onto stack
    (i32.const 2)                                                              ;; Put a 2 on the stack
    (i32.div_s)                                                                ;; Stack2 / Stack1
    (local.set $var5)                                                          ;; Set var 'temp4' from stack
    (local.get $var5)                                                          ;; Place var 'temp4' onto stack
  )                                                                          ;; END 'complex_calc' function definition.
  ...
  (func $main (result i32)
    ...
    (call $complex_calc)                                                       ;; Call function complex_calc
