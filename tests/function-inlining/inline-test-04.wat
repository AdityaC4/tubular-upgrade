(module
  ...
  (func $simple_add (param $var0 i32) (param $var1 i32) (result i32)
    ;; Variables
  ...
  )                                                                          ;; END 'simple_add' function definition.
  
  (export "simple_add" (func $simple_add))
  
  (func $complex_multiply (param $var3 i32) (param $var4 i32) (result i32)
    ;; Variables
    (local $var6 i32)                                                          ;; Variable: temp1
    (local $var7 i32)                                                          ;; Variable: temp2
    (local $var8 i32)                                                          ;; Variable: temp3
    (local $var9 i32)                                                          ;; Variable: result
    
    ;; Temp Variables
    
    (local.get $var3)                                                          ;; Place var 'x' onto stack
    (i32.const 2)                                                              ;; Put a 2 on the stack
    (i32.mul)                                                                  ;; Stack2 * Stack1
    (local.set $var6)                                                          ;; Set var 'temp1' from stack
    (local.get $var4)                                                          ;; Place var 'y' onto stack
    (i32.const 3)                                                              ;; Put a 3 on the stack
    (i32.mul)                                                                  ;; Stack2 * Stack1
    (local.set $var7)                                                          ;; Set var 'temp2' from stack
    (local.get $var6)                                                          ;; Place var 'temp1' onto stack
    (local.get $var7)                                                          ;; Place var 'temp2' onto stack
    (i32.add)                                                                  ;; Stack2 + Stack1
    (local.set $var8)                                                          ;; Set var 'temp3' from stack
    (local.get $var8)                                                          ;; Place var 'temp3' onto stack
    (i32.const 4)                                                              ;; Put a 4 on the stack
    (i32.mul)                                                                  ;; Stack2 * Stack1
    (local.set $var9)                                                          ;; Set var 'result' from stack
    (local.get $var9)                                                          ;; Place var 'result' onto stack
  )                                                                          ;; END 'complex_multiply' function definition.
  
  (export "complex_multiply" (func $complex_multiply))
  
  (func $main (result i32)
    ;; Variables
    (local $var11 i32)                                                         ;; Variable: sum
    (local $var12 i32)                                                         ;; Variable: product
    ...
    (i32.const 3)                                                              ;; Put a 3 on the stack
    (i32.add)                                                                  ;; Stack2 + Stack1
    (local.set $var11)                                                         ;; Set var 'sum' from stack
    (local.get $var11)                                                         ;; Place var 'sum' onto stack
    (i32.const 2)                                                              ;; Put a 2 on the stack
    (call $complex_multiply)                                                   ;; Call function complex_multiply
    (local.set $var12)                                                         ;; Set var 'product' from stack
    (local.get $var12)                                                         ;; Place var 'product' onto stack
