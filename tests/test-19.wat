(module
  ...
  (func $String2Int (param $var0 i32) (result i32)
    ;; Variables
    (local $var2 i32)                                                          ;; Variable: out
    (local $var3 i32)                                                          ;; Variable: pos
    (local $var4 i32)                                                          ;; Variable: is_neg
    ...
    (i32.const 0)                                                              ;; Put a 0 on the stack
    (local.set $var2)                                                          ;; Set var 'out' from stack
    (i32.const 0)                                                              ;; Put a 0 on the stack
    (local.set $var3)                                                          ;; Set var 'pos' from stack
    (i32.const 0)                                                              ;; Put a 0 on the stack
    (local.set $var4)                                                          ;; Set var 'is_neg' from stack
    ;; Test condition for if.
    (local.get $var0)                                                          ;; Place var 'in' onto stack
    (i32.const 0)                                                              ;; Put a 0 on the stack
    ...
    (block $exit1                                                              ;; Outer block for breaking while loop.
      (loop $loop1                                                             ;; Inner loop for continuing while.
        ...
        (local.get $var3)                                                          ;; Place var 'pos' onto stack
        (local.get $var0)                                                          ;; Place var 'in' onto stack
        (call $_strlen)                                                            ;; Call _strlen for size()
        ...
        ;; WHILE Loop body...
        (local.get $var2)                                                          ;; Place var 'out' onto stack
        ...
        (i32.const 48)                                                             ;; Put a char \48 on the stack
    ...
    ;; Test condition for if.
    (local.get $var4)                                                          ;; Place var 'is_neg' onto stack
    (if                                                                        ;; Execute code based on result of condition.
      (then                                                                      ;; 'then' block
        (i32.const 0)                                                              ;; Put a 0 on the stack
        (local.get $var2)                                                          ;; Place var 'out' onto stack
    ...
    (local.get $var2)                                                          ;; Place var 'out' onto stack
  )                                                                          ;; END 'String2Int' function definition.
  
  (export "String2Int" (func $String2Int))
