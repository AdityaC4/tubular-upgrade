(module
  ...
  (func $PI (result f64)
    ...
    (f64.const 3.14159)                                                        ;; Put a 3.14159 on the stack
  )                                                                          ;; END 'PI' function definition.
  
  (export "PI" (func $PI))
  
  (func $Get3 (result i32)
    ;; Variables
    
    ;; Temp Variables
    
    (call $PI)                                                                 ;; Call function PI
    (i32.trunc_f64_s)                                                          ;; Convert to int.
  )                                                                          ;; END 'Get3' function definition.
  
  (export "Get3" (func $Get3))
