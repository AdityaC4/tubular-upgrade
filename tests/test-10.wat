(module
  ...
  (func $Bracketize (param $var0 i32) (result i32)
    ;; Variables
    ...
    (i32.const 91)                                                             ;; Put a char \91 on the stack
    ...
    (i32.const 93)                                                             ;; Put a char \93 on the stack
    i32.store8                                                                 ;; Store the char at the address
    (local.get $temp1)                                                         ;; Return address of the string
    call $_strcat                                                              ;; Concatenate two strings
  )                                                                          ;; END 'Bracketize' function definition.
  
  (export "Bracketize" (func $Bracketize))
